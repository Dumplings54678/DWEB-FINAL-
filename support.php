...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo-icon { width: 52px; height: 52px; background: linear-gradient(135deg, #06B6D4, #3B82F6); border-radius: 12px; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 10px rgba(6,182,212,0.3); }
        ...
        .nav-link { color: #1e293b; text-decoration: none; font-weight: 500; font-size: 16px; position: relative; }
        ...
        .signin-link { color: #1e293b; text-decoration: none; font-weight: 500; }
        .signin-link:hover { color: #06B6D4; }
        .get-started-btn { background: #000000; color: white; text-decoration: none; padding: 12px 28px; border-radius: 40px; font-weight: 600; transition: all 0.3s ease; display: inline-flex; align-items: center; gap: 8px; }
        .get-started-btn:hover { background: #1e293b; transform: translateY(-3px); }
        .page-header { background: linear-gradient(135deg, #06B6D4, #14B8A6, #0891b2); padding: 140px 0 80px; text-align: center; color: white; position: relative; overflow: hidden; }
        ...
        .section-title { font-family: 'Enriqueta', serif; font-size: 36px; color: #0f172a; text-align: center; margin-bottom: 20px; }
        ...
        .back-to-top { position: fixed; bottom: 30px; right: 30px; width: 50px; height: 50px; background: linear-gradient(135deg, #06B6D4, #14B8A6); color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; box-shadow: 0 4px 15px rgba(6,182,212,0.3); transition: all 0.3s ease; opacity: 0; visibility: hidden; z-index: 99; }
...
<body>
    <nav class="navbar" id="navbar">
        <div class="nav-container">
            ...
            <div class="nav-right">
                ...
                <a href="register.php" class="get-started-btn">Get Started Free <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
    </nav>
    ...
    <section class="page-header">
        <div class="container">
            <h1 data-aos="fade-up">Support Center</h1>
            <p data-aos="fade-up" data-aos-delay="100">We're here to help you succeed</p>
        </div>
    </section>
    ...
    <section class="content-section">
        <div class="container">
            <div class="coming-soon" data-aos="fade-up">
                ...
                <p>Our support team is preparing to assist you better.</p>
                <p style="margin-top: 20px; color: #06B6D4;">For now, email us at support@PLANORA.com</p>
            </div>
        </div>
    </section>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                ...
                <div class="copyright">© 2026 PLANORA. All rights reserved.</div>

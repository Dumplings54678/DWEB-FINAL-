...
<head>
    ...
    <title>Documentation - PLANORA</title>
...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <h1 data-aos="fade-up">Documentation</h1>
            <p data-aos="fade-up" data-aos-delay="100">Learn how to use PLANORA effectively</p>
        </div>
    </section>
    ...
    <section class="content-section">
        <div class="container">
            <div class="coming-soon" data-aos="fade-up">
                ...
                <p>We're currently preparing comprehensive guides and documentation.</p>
                <p style="margin-top: 20px; color: #06B6D4;">Check back later for updates!</p>
            </div>
        </div>
    </section>
